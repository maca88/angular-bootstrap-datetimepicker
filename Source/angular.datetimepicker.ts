                            ...
                            pre: (scope, input, attrs, controller) => {
                                ...
                                if (attrs.bsIcon !== undefined || attrs.bsClearIcon !== undefined) {
                                    ...
                                    if (tAttrs.bsIcon !== undefined && tAttrs.bsClearIcon !== undefined) {
                                        ...
                                        '</span>';
                                        rightIcon += '<span class="input-group-addon" data-action="clear">' +
                                        '<span class="glyphicon glyphicon-' + clearIcon + '" ></span>' +
                                        '</span>';
                                    } else { //only one icon is present, position it to the left
                                        rightIcon = '<span class="input-group-addon" ' + (tAttrs.bsClearIcon !== undefined ? 'data-action="clear"' : '') + ' >' +
                            ...
                            post: (scope, input, attrs, controller) => {
                                ...
                                if (controller) {
                                    ...
                                    if (tAttrs.dpEnabledDates) {
                                        scope.$watch(tAttrs.dpEnabledDates, (val) => {
                                            if (dtInstance)
                                    ...
                                    if (tAttrs.dpDaysOfWeekDisabled) {
                                        scope.$watch(tAttrs.dpDaysOfWeekDisabled, (val) => {
                                            if (dtInstance)
